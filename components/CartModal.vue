  ...
  <Teleport to="body">
    <transition name="fade">
      <div v-if="cart.isModalOpen"
        ...
        <div class="bg-neutral-900 w-full max-w-md max-h-[90vh] overflow-y-auto rounded-[2.5rem] p-8 border border-white/10 shadow-2xl relative custom-scrollbar">
          ...
          <div class="mb-8">
            <label class="text-neutral-500 text-[9px] uppercase tracking-[0.3em] font-black mb-3 block">Pagamento na entrega/retirada</label>
            <div class="grid grid-cols-3 gap-2">
              <button v-for="method in ['PIX', 'CARTÃO', 'DINHEIRO']" :key="method"
          ...
          <button @click="sendOrder" :disabled="isSubmitting"
            class="w-full py-5 rounded-2xl font-black uppercase text-xs tracking-[0.3em] transition-all active:scale-95 shadow-2xl flex justify-center items-center"
